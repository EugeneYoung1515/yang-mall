...
<head>
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="http://www.dbmall.com/shop/resource/font/font-awesome/css/font-awesome-ie7.min.css">
    <![endif]-->
    <script>
...
<div class="ncc-wrapper">
    ...
    <div class="ncc-main">
        ...
        <form action="showcode" method="POST" id="buy_form">
            <!--
            <input type="hidden" name="pay_sn" value="550619635104388104">
            -->
            <input type="hidden" name="orderId" value="${orderId}">
            <input type="hidden" id="payment_code" name="payment_code" value="">
            <div class="ncc-receipt-info">
                <div class="ncc-receipt-info-title">
                    <h3>请您及时付款，以便订单尽快处理！                    在线支付金额：<strong>￥${payTotal}</strong>
                    </h3>
                </div>
                <table class="ncc-table-style">
                    ...
                    <tr>
                        <td></td>
                        <td class="tl">${orderId}</td>
                        <td class="tl">在线支付</td>
                        <td class="tl">￥${payTotal}</td>
                        <td>快递</td>
                    </tr>
                    </tbody>
                </table>
                ...
                <ul class="ncc-payment-list">
                    <li payment_code="alipay">
                        <label for="pay_alipay">
                            <i></i>
                            <div class="logo" for="pay_2"> <img src="http://www.yangmall.com/shop/templates/default/images/payment/alipay_logo.gif" /> </div>
                        </label>
                    </li>
                    <li payment_code="wxpay">
                        <label for="pay_wxpay">
                            <i></i>
                            <div class="logo" for="pay_6"> <img src="http://www.yangmall.com/shop/templates/default/images/payment/wxpay_logo.gif" /> </div>
                        </label>
                    </li>
                </ul>
            </div>
