...
public class UserController {
    ...
    @CrossOrigin(origins = {"http://www.yangmall.com","http://search.yangmall.com","http://item.yangmall.com","http://cart.yangmall.com","http://order.yangmall.com","http://pay.yangmall.com"},methods = {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT},allowedHeaders = {"X-Requested-With","Content-Type","Accept"},allowCredentials = "true")
