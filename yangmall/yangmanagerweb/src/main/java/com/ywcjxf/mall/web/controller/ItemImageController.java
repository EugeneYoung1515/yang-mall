...
public class ItemImageController {
    ...
    public String ItemImageUploadAndCreateHtml(MultipartFile file, RedirectAttributes redirectAttributes){
        if(!file.isEmpty()) {
            ...
            File file1 = new File("/Users/eugeneyoung/Downloads/itemimage/" + uuid + suffix);//这里硬编码了
            File file2 = new File("/Users/eugeneyoung/Downloads/itemimage/360/" + uuid + suffix);//这里硬编码了
            File file3 = new File("/Users/eugeneyoung/Downloads/itemimage/240/" + uuid + suffix);//这里硬编码了
            File file4 = new File("/Users/eugeneyoung/Downloads/itemimage/60/" + uuid + suffix);//这里硬编码了
            try {
